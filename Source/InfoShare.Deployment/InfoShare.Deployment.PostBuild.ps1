...
Copy-Item (Join-Path $directory "InfoShare.Deployment.dll-help.xml") "$modulepath/InfoShare.Deployment" -Force
#Copy-Item (Join-Path $directory "InfoShare.Deployment.psd1") "$modulepath/InfoShare.Deployment/InfoShare.Deployment.psd1" -Force
