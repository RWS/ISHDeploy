...
namespace ISHDeploy.Tests.Data.Managers
{
    ...
    public class TextConfigManagerTest : BaseUnitTest
    {
        ...
        public void CommentBlock_One_block_commented()
        {
            ...
            // Act
            _textConfigManager.CommentBlock(FilePath, BasePathsOperation.AuthorASPTreeHtm.TranslationJobHack);
        ...
        public void CommentBlock_Broken_comment_pattern()
        {
            ...
            // Assert
            FileManager.Received(1).WriteAllLines(FilePath, Arg.Any<string[]>());
            Logger.Received(1).WriteWarning(Arg.Is($"Cannot not find end of the comment pattern '{BasePathsOperation.AuthorASPTreeHtm.TranslationJobHack}' in the file: {FilePath}"));
        ...
        public void UncommentBlock_One_block_commented()
        {
            ...
            // Act
            _textConfigManager.UncommentBlock(FilePath, BasePathsOperation.AuthorASPTreeHtm.TranslationJobHack);
