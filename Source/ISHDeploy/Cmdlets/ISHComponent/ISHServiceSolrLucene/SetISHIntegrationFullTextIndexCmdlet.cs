...
namespace ISHDeploy.Cmdlets.ISHComponent.ISHServiceSolrLucene
{
    ...
    /// <para type="description">The Set-ISHIntegrationFullTextIndex cmdlet sets target lucene Uri.</para>
    ...
    /// </example>
    [Cmdlet(VerbsCommon.Set, "ISHIntegrationFullTextIndex")]
    public sealed class SetISHIntegrationFullTextIndexCmdlet : BaseHistoryEntryCmdlet
    {
        /// <summary>
        ...
        {
            var operation = new SetISHServiceSolrLuceneOperation(Logger, ISHDeployment, Uri);
            operation.Run();
        }
    }
}
