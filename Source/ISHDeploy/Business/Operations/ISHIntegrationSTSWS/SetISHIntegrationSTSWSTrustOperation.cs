...
namespace ISHDeploy.Business.Operations.ISHIntegrationSTSWS
{
    ...
    public class SetISHIntegrationSTSWSTrustOperation : BasePathsOperation, IOperation
    {
        ...
        public SetISHIntegrationSTSWSTrustOperation(ILogger logger, Models.ISHDeploymentInternal ishDeployment, Uri endpoint, Uri mexEndpoint, BindingType bindingType) :
