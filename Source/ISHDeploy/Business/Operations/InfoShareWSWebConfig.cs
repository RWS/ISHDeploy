...
namespace ISHDeploy.Business.Operations
{
    ...
    public partial class OperationPaths
    {
        ...
        public static class InfoShareWSWebConfig
        {
            ...
            /// </summary>
            public const string CertificateThumbprintXPath = "configuration/system.serviceModel/behaviors/serviceBehaviors/serviceBehaviors[@name='']/serviceCredentials[@useIdentityConfiguration='true']/serviceCertificate/@findValue";
        }
    }
}
