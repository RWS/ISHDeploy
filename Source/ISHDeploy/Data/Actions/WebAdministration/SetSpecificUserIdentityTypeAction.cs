...
{
    /// <summary>
    /// Sets identity type of specific application pool as SpecificUser
    /// </summary>
    /// <seealso cref="SingleFileCreationAction" />
    public class SetSpecificUserIdentityTypeAction : BaseAction
    {
        /// <summary>
        ...
        public SetSpecificUserIdentityTypeAction(ILogger logger, string appPoolName)
            : base(logger)
        {
