...
namespace ISHDeploy.Documentation.Tests
{
    ...
    {
        [TestMethod]
        public void Check_all_links_of_DOC_portal_returns_OK_response()
        {
            // Arrange
            ...
            filesList.AddRange(Directory.GetFiles(pathToWebFolder, "*.png", SearchOption.AllDirectories).ToList());
            filesList.AddRange(Directory.GetFiles(pathToWebFolder, "*.jpg", SearchOption.AllDirectories).ToList());
