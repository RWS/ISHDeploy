...
namespace ISHDeploy.Data.Actions.Certificate
{
    ...
    public class GetCertificateSubjectByThumbprintAction : BaseActionWithResult<string>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCertificateSubjectByThumbprintAction"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        /// <param name="thumbprint">The certificate thumbprint.</param>
        /// <param name="returnResult">The delegate that returns all text of file.</param>
        public GetCertificateSubjectByThumbprintAction(ILogger logger, string thumbprint, Action<string> returnResult)
		...
		{
            return _certificateManager.GetCertificateSubjectByThumbprint(_thumbprint);
        }
	}
}
