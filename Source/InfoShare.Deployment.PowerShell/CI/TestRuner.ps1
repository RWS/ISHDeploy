...
#$artifactPath ='C:\Program Files (x86)\Jenkins\workspace\Build InfoShare.Deployment develop branch on commit\Source\InfoShare.Deployment\bin\Release\InfoShare.Deployment.dll'

$targetPath = '\\10.91.5.34\C$\Users\infoshareserviceuser\Documents\WindowsPowerShell\Modules\InfoShare.Deployment'
