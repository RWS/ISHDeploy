...
namespace ISHDeploy.Cmdlets.ISHServiceCrawler
{
    ...
    /// </example>
    [Cmdlet(VerbsLifecycle.Enable, "ISHServiceCrawler")]
    public sealed class EnableISHServiceCrawlerCmdlet : BaseHistoryEntryCmdlet
    {
        /// <summary>
        /// Executes cmdlet
        /// </summary>
        ...
        {
            var operation = new EnableISHComponentOperation(Logger, ISHDeployment, true, ISHComponentName.Crawler);
