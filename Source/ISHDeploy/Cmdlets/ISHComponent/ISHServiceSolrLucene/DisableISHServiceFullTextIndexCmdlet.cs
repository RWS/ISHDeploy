...
namespace ISHDeploy.Cmdlets.ISHComponent.ISHServiceSolrLucene
{
    ...
    public sealed class DisableISHServiceSolrLuceneBuilderCmdlet : BaseHistoryEntryCmdlet
    {
        /// <summary>
        /// Executes cmdlet
        /// </summary>
        ...
        {
            var operation = new DisableISHComponentOperation(Logger, ISHDeployment, ISHComponentName.SolrLucene);
